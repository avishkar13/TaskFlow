...
function TaskForm({ taskToEdit, closeEditMode }) {
  ...
  return (
    <div className="bg-slate-900 h-[15%] w-[95%] md:w-[88%] mx-auto rounded-lg py-3 shadow-lg hover:shadow-2xl transition-shadow duration-300">
      <h2 className="text-white text-center font-serif text-xl mb-6">
        {taskToEdit ? 'Edit Task' : 'Task Management Dashboard'}
      </h2>
      <form className="h-[70%] w-[95%] md:w-[80%] mx-auto" onSubmit={handleSubmit}>
        <div className="mb-4">
          <input
            className="w-full h-8 px-3 bg-slate-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
            type="text"
        ...
        <div className="mb-4 flex justify-between gap-4">
          <input
            className="w-52 h-8 px-3 bg-slate-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300 cursor-pointer"
            type="date"
            name="dueDate"
